...
- [x] (3 pts) **Customize the toolbar and icons**
  ...
  - ![GIF showing toolbar customization](http://i.imgur.com/link/to/your/gif/file.gif) <!-- Replace this link with your actual image/GIF link -->
    ![Lab6](https://github.com/user-attachments/assets/3e074dd0-7a86-4ebe-8a01-91777f9e687b)
...
I didn't struggle with the lab bc the instructions are straight forward. <!-- Replace this with your specific challenges and experiences -->
